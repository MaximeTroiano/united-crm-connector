...
function API(api_url) {
      ...
      return regeneratorRuntime.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
            case 0:
              data = _args16.length > 4 && _args16[4] !== undefined ? _args16[4] : {};
              ...
              return _context16.abrupt("return", _this.instance.post("/data/".concat(entity, "/").concat(entityId, "/").concat(relation, "/").concat(relationId), data, _this.authHeader()).then(function (result) {
      ...
      return regeneratorRuntime.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            ...
            case 6:
              return _context17.abrupt("return", _this.instance["delete"]("/data/".concat(entity, "/").concat(entityId, "/").concat(relation, "/").concat(relationId), _this.authHeader()).then(function (result) {
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee18(entity, id) {
      return regeneratorRuntime.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            ...
            case 6:
              return _context18.abrupt("return", _this.instance["delete"]("/data/".concat(entity, "/").concat(id), _this.authHeader()).then(function (result) {
      ...
      return regeneratorRuntime.wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            case 0:
              entity = _args19.length > 0 && _args19[0] !== undefined ? _args19[0] : null;

              _this.log.request(0, "Config", entity || "global");

              URL = !entity ? "/config" : "/config/".concat(entity);
              return _context19.abrupt("return", _this.instance.get(URL, _this.authHeader()).then(_this.handleResponse)["catch"](_this.handleError));
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee20(func) {
      var parameters,
          _args20 = arguments;
      return regeneratorRuntime.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            case 0:
              parameters = _args20.length > 1 && _args20[1] !== undefined ? _args20[1] : {};

              _this.log.request(0, "database", func);

              return _context20.abrupt("return", _this.instance.post("/database/".concat(func), parameters, _this.authHeader()).then(_this.handleResponse)["catch"](_this.handleError));
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee21(fileData, file, folderId) {
        ...
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 4:
              ...
              return _context21.abrupt("return", _this.log.error(1, "Canceled"));

            case 6:
              return _context21.abrupt("return", _this.instance.post("/files", file, _this.authHeader({
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee22(fileId) {
        ...
        while (1) {
          switch (_context22.prev = _context22.next) {
            case 0:
              ...
              return _context22.abrupt("return", _this.instance.get("/data/files/".concat(fileId, "/download"), _this.authHeader({}, {
                responseType: "blob"
              })).then(_this.handleResponse)["catch"](_this.handleError));
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee23(type, query) {
        ...
        while (1) {
          switch (_context23.prev = _context23.next) {
            case 0:
              ...
              return _context23.abrupt("return", _this.instance.post("/kpi", {
                type: type,
                query: query
              }, _this.authHeader()).then(_this.handleResponse)["catch"](_this.handleError));
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee24(functionName, data) {
        ...
        while (1) {
          switch (_context24.prev = _context24.next) {
            case 0:
              ...
              return _context24.abrupt("return", _this.instance.post("/exec/".concat(functionName), data, _this.authHeader()).then(_this.handleResponse)["catch"](_this.handleError));
      ...
      while (1) {
        switch (_context25.prev = _context25.next) {
          case 0:
            ...
            return _context25.abrupt("return", _this.instance.get("/saas", {
              headers: {
